                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-book"></i> Subject <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Takes Subject</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-users"></i> Student <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a>Student List<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                          <li class="sub_menu"><a href="level2.html">1st Year</a>
                          </li>
                          <li><a href="#level2_1">2nd Year</a>
                          </li>
                          <li><a href="#level2_1">3rd Year</a>
                          </li>
                          <li><a href="#level2_1">4th Year</a>
                          </li>
                        </ul>
                      </li>
                    </ul>

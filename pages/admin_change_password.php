                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="" novalidate>
                      <span class="section">Change Password</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="old_pass" name="old_pass" required="required" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1">
						            </div>
                      </div>
